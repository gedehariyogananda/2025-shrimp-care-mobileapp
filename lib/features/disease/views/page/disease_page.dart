...
class _DiseasePageState extends State<DiseasePage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      Provider.of<DiseasesProvider>(context, listen: false).getAllDisease();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    selectedSort ??= diseaseProvider.currentSort;
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            _showSortBottomSheet(
                                context, diseaseProvider, selectedSort,
                                (value) {
                              setState(() {
                                selectedSort = value;
                              });
...
void _showSortBottomSheet(
  ...
  DiseasesProvider diseaseProvider,
  String? selectedSort,
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        // update selectedSort di halaman utama
                        onSortSelected(tempSort);
                        // update di provider
                        diseaseProvider.setSort(tempSort);
